...
from PIL import Image, ImageTk  # Required for displaying video frames
...
class AccessControlApp:
    ...
    def __init__(self, root):
        ...
        self.current_frame = None  # For displaying current video frame
    ...
    def update_video_feed(self):
        ...
        if self.recognition_running and not self.stop_flag:
